...
struct Colors {
    ...
    public static let yellow = UIColor("#f8d309")
    public static let red = UIColor("#cd4f32")
    public static let orange = UIColor("#ff7058")
    public static let primary = UIColor("#272727")
    public static let lightGrey = UIColor("#dbdbdb")
}

/**
 Grabbed this piece of code from: https://github.com/yeahdongcn/UIColor-Hex-Swift
